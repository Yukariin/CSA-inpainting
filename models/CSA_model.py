...
class CSA_model(nn.Module):
    def __init__(self, threshold, fixed_mask,
        ...
        # whether we need to calculate the temp varaiables this time.
        self.cal_fixed_flag = True

        # these two variables are for accerlating MaxCoord,
        # it is constant tensors,
    ...
    def forward(self, input):
        ...
        if self.fixed_mask and self.cal_fixed_flag is False:
